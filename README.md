...
### 🎓 CS Student @ FHNW · 🔐 Cybersecurity Enthusiast · 🏎️ Car Lover

[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=00FF41&center=true&vCenter=true&width=600&lines=Computer+Science+%40+FHNW;Cybersecurity+%7C+Ethical+Hacker+in+Training;Java+%7C+Lua+%7C+C%2B%2B+%28coming+soon%29;0-100+in+3.2s+%F0%9F%8F%8E%EF%B8%8F)](https://git.io/typing-svg)
...
public class Developer {
    ...
    String university  = "FHNW – Fachhochschule Nordwestschweiz";
    String degree      = "BSc Computer Science";
    String passion     = "Cybersecurity & Ethical Hacking";

    String[] languages = {"Java", "Lua", "C++ (learning soon)"};
    String[] interests = {"CTF Challenges", "Network Security",
                          "Cars", "Low-level Programming"};

    String lifePhilosophy = "Shift fast, stay secure. 🏎️🔐";
}
```
...
> *"In cybersecurity, the best offense is a thorough defense."*

- 🕵️ Fascinated by **penetration testing**, **network security** and **CTFs**
- 🧠 Always learning about new **exploits, vulnerabilities** and attack vectors
- 🛡️ Believer in ethical hacking and responsible disclosure
- 🔍 Currently diving deep into the security coursework at **FHNW**
...
![GitHub Streak](https://streak-stats.demolab.com?user=YOUR_USERNAME&theme=radical&hide_border=false&border_radius=5&date_format=j%20M%5B%20Y%5D)
